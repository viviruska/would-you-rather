...
This is my solution code for the final assessment project for Udacity's React & Redux course.
...
* clone the Project - `git@github.com:viviruska/would-you-rather.git`
